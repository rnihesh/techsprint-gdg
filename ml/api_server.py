...
# Support running from root or ml directory
...
def classify():
    ...
    try:
        ...
        return (
            jsonify({"success": False, "error": f"Failed to fetch image: {str(e)}"}),
            400,
        )
        ...
        return (
            jsonify({"success": False, "error": f"Classification failed: {str(e)}"}),
            500,
        )
